  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Learn trading free — beginner to advanced guides on stocks, crypto, and Bitcoin. No experience needed. Practice with $10K virtual cash on TradeHQ." />
        ...
        <meta property="og:description" content="Learn trading free — beginner to advanced guides on stocks, crypto, and Bitcoin. No experience needed." />
        ...
        <meta name="twitter:description" content="Learn trading free — beginner to advanced guides on stocks, crypto, and Bitcoin." />
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8 animate-fade-in" aria-label="Breadcrumb">
            <Link to="/" className="flex items-center gap-1 hover:text-primary transition-colors">
              <Home className="w-4 h-4" /><span>TradeHQ</span>
            </Link>
          ...
          {/* Article Cards — SEO Content Engine */}
          <div className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {LEARN_ARTICLES.map((article) => (
                <Link
                  ...
                  className="group bg-white/[0.02] border border-white/[0.08] rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 hover:scale-[1.02]"
              ...
              return (
                ...
                >
                  <div className="relative h-80 overflow-hidden">
                    <img 
                      src={lesson.image} 
                      alt={`${lesson.title} course - TradeHQ`}
                      loading="lazy"
          ...
          <Card className="p-12 bg-gradient-to-br from-primary/5 via-background to-background border-primary/10 backdrop-blur-xl">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                Practice these strategies with your $10,000 virtual cash. The best way to learn is by doing.
              </p>
              <Link to="/trade">
