...
export const tradingGlossary: GlossaryTerm[] = [
  ...
  },
  {
    ...
    definition: "Control larger positions with borrowed funds. 10x leverage means $1,000 controls $100,000. Amplifies both profits and losses — the most dangerous tool in trading.",
